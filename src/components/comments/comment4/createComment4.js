...
import { createComment4 } from '../../../store/actions/commentActions';

class CreateComment4 extends React.Component {
    state= {
        content: '',
    }
    handleChange = (e) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.createComment4(this.state);
    }
   render(){
       return(
           <div>
...
const mapDispatchToProps = (dispatch) => {
    return{
        createComment4: (comment4) => dispatch(createComment4(comment4))
    }
}

export default connect(null, mapDispatchToProps)(CreateComment4);

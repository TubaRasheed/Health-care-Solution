...
import { createComment6 } from '../../../store/actions/commentActions';

class CreateComment6 extends React.Component {
    state= {
        content: '',
    }
    handleChange = (e) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.createComment6(this.state);
    }
   render(){
       return(
           <div>
...
const mapDispatchToProps = (dispatch) => {
    return{
        createComment6: (comment6) => dispatch(createComment6(comment6))
    }
}

export default connect(null, mapDispatchToProps)(CreateComment6);

...
import { createComment8 } from '../../../store/actions/commentActions';

class CreateComment8 extends React.Component {
    state= {
        content: '',
    }
    handleChange = (e) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.createComment8(this.state);
    }
   render(){
       return(
           <div>
...
const mapDispatchToProps = (dispatch) => {
    return{
        createComment8: (comment8) => dispatch(createComment8(comment8))
    }
}

export default connect(null, mapDispatchToProps)(CreateComment8);

...
import { createComment2 } from '../../../store/actions/commentActions';

class CreateComment2 extends React.Component {
    state= {
        content: '',
    }
    handleChange = (e) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.createComment2(this.state);
    }
   render(){
       return(
           <div>
...
const mapDispatchToProps = (dispatch) => {
    return{
        createComment2: (comment2) => dispatch(createComment2(comment2))
    }
}

export default connect(null, mapDispatchToProps)(CreateComment2);

...
import { createComment3 } from '../../../store/actions/commentActions';

class CreateComment3 extends React.Component {
    state= {
        content: '',
    }
    handleChange = (e) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.createComment3(this.state);
    }
   render(){
       return(
           <div>
...
const mapDispatchToProps = (dispatch) => {
    return{
        createComment3: (comment3) => dispatch(createComment3(comment3))
    }
}

export default connect(null, mapDispatchToProps)(CreateComment3);
